...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Gold toolsets (CLI + messaging platforms)
    #
    ...
    "gold-email": {
        "description": "Email bot toolset - interact with Gold via email (IMAP/SMTP)",
        "tools": _GOLD_CORE_TOOLS,
        "includes": []
    },
    ...
    "gold-sms": {
        "description": "SMS bot toolset - interact with Gold via SMS (Twilio)",
        "tools": _GOLD_CORE_TOOLS,
        "includes": []
    },
    ...
    "gold-gateway": {
        ...
        "tools": [],
        "includes": ["gold-telegram", "gold-discord", "gold-whatsapp", "gold-slack", "gold-signal", "gold-bluebubbles", "gold-homeassistant", "gold-email", "gold-sms", "gold-mattermost", "gold-matrix", "gold-dingtalk", "gold-feishu", "gold-wecom", "gold-wecom-callback", "gold-weixin", "gold-qqbot", "gold-webhook"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    # Check for cycles / already-resolved (gold deps).
    # Silently return [] — either this is a gold (not a bug, tools already
    ...
    # sibling includes so gold dependencies are only resolved once and
