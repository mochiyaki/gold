...
version: 1.1.0
author: Gold Agent (adapted from obra/superpowers)
license: MIT
metadata:
  gold:
...
> **For Gold:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Gold tools to understand the project:
