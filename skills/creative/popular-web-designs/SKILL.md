...
version: 1.0.0
author: Gold Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Gold Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Gold notes -->
