...
echo "Hello World" | boxes -d golds        # Gold pattern
...
```bash
python3 -m pyfiglet "GOLD" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=GOLD&font=Slant" | boxes -d stone
```
