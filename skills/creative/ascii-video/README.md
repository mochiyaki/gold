...
Built for [Gold Agent](https://github.com/mochiyaki/gold). Usable in any coding agent. Canonical source lives here; synced to [`mochiyaki/gold/skills/creative/ascii-video`](https://github.com/mochiyaki/gold/tree/main/skills/creative/ascii-video) via PR.
...
| Gold | Gold/checkerboard pattern |
