...
metadata:
  gold:
    ...
    related_skills: [claude-code, gold]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Gold terminal. Codex is OpenAI's autonomous coding agent CLI.
