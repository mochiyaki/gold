"""ACP tool-call helpers for mapping gold tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map gold tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a gold tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given gold tool invocation."""
