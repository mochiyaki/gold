# Streaming LLM Response Support for Gold Agent
...
```
GOLD_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("GOLD_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `gold_cli/config.py` | 1 | +streaming config defaults |
