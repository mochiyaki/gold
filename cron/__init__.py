"""
Cron job scheduling system for Gold Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    gold gateway install    # Install as a user service
    sudo gold gateway install --system  # Linux servers: boot-time system service
    gold gateway            # Or run in foreground
