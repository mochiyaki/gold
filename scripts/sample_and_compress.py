...
DEFAULT_DATASETS = [
    "mochiyaki/swe-terminus-agent-glm-kimi-minimax",
    "mochiyaki/gold-megascience-sft1",
    "mochiyaki/Gold-Thinking-GLM-4.7-SFT2",
    "mochiyaki/Gold-Thinking-GLM-4.7-SFT1",
    "mochiyaki/terminal-tasks-glm-gold"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "mochiyaki/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload mochiyaki/{output_name} {final_output}")
