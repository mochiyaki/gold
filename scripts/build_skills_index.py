#!/usr/bin/env python3
"""Build the Gold Skills Index — a centralized JSON catalog of all skills.
...
`gold skills search/install` can use it without hitting the GitHub API.
...
# Ensure GOLD_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("GOLD_HOME", os.path.join(os.path.expanduser("~"), ".gold"))
...
def main():
    print("Building Gold Skills Index...", flush=True)
