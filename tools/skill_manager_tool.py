...
~/.gold/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.gold/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.gold/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.gold/skills/; existing skills can be modified wherever they live.\n\n"
