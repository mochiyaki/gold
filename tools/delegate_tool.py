...
# (gold-* prefixed), and scenario toolsets.
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    if not api_key:
        raise ValueError(
            ...
            f"Set the appropriate environment variable or run 'gold auth'."
        )
...
def _load_config() -> dict:
    ...
    to the persistent config (gold_cli/config.py load_config()) so that
