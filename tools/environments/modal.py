...
wrapper, while preserving Gold' persistent snapshot behavior across sessions.
"""
...
_SNAPSHOT_STORE = get_gold_home() / "modal_snapshots.json"
...
class ModalEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        async def _create_sandbox(image_spec: Any):
            app = await _modal.App.lookup.aio("gold", create_if_missing=True)
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files("/root/.gold"),
