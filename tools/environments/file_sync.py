...
_FORCE_SYNC_ENV = "GOLD_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.gold") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.gold to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``GOLD_FORCE_FILE_SYNC=1`` is set.
