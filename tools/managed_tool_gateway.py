...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "mochiyaki.com"
...
def auth_json_path():
    """Return the Gold auth store path, respecting GOLD_HOME overrides."""
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from gold_cli.auth import resolve_nous_access_token
