...
Trust levels:
  - builtin:   Ships with Gold. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.gold/\.env|\~/\.gold/\.env',
     "gold_env_access", "critical", "exfiltration",
     "directly references Gold secrets file"),
    ...
    (r'\.gold/config\.yaml|\.gold/SOUL\.md',
     "gold_config_mod", "critical", "persistence",
     "references Gold configuration files directly"),
