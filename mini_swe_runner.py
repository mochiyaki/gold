#!/usr/bin/env python3
"""
SWE Runner with Gold Trajectory Format

A runner that uses Gold's built-in execution environments
(local, docker, modal) and outputs trajectories in the Gold format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Gold's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Gold format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Gold format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Gold's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Gold Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Gold's built-in execution environments
    and outputs trajectories in Gold format.
    """
    ...
    def _convert_to_gold_format(
        ...
        """
        Convert internal message format to Gold trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Gold trajectory format
        trajectory = self._convert_to_gold_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Gold trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Gold Trajectory Format")
    print("=" * 60)
