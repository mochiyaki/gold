...
Hooks are discovered from ~/.gold/hooks/ directories, each containing:
    ...
    def _register_builtin_hooks(self) -> None:
        ...
        try:
            ...
            self._loaded_hooks.append({
                "name": "boot-md",
                "description": "Run ~/.gold/BOOT.md on gateway startup",
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    f"gold_hook_{hook_name}", handler_path
                )
