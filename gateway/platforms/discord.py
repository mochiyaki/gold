...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("GOLD_DISCORD_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("GOLD_DISCORD_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Gold session")
        ...
        @tree.command(name="status", description="Show Gold session status")
        ...
        @tree.command(name="stop", description="Stop the running Gold agent")
        ...
        @tree.command(name="update", description="Update Gold Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the Gold gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Gold session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Gold in the thread",
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        """
        try:
            from gold_cli.commands import discord_skill_commands_by_category
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Gold session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Gold: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Gold"
        if len(content) > 80:
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``gold update --gateway``
...
if DISCORD_AVAILABLE:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``gold update`` prompts.
