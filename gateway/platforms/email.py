"""
Email platform adapter for the Gold gateway.

Allows users to interact with Gold by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Gold Agent")
        ...
        msg_id = f"<gold-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
