...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_gold_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/gold")
            async def handle_gold_command(ack, command):
                await ack()
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "gold_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "gold_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "gold_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "gold_approve_once": "once",
            "gold_approve_session": "session",
            "gold_approve_always": "always",
            "gold_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from gold_cli.commands import slack_subcommand_map
