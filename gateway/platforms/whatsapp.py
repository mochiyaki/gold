...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    # Default bridge location relative to the gold install
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._session_path: Path = Path(config.extra.get(
            "session_path",
            get_gold_dir("platforms/whatsapp/session", "whatsapp/session")
        ))
        ...
        try:
            ...
            if data.get("status") != "connected":
                ...
                for attempt in range(15):
                    ...
                    print(f"[{self.name}]   If session expired, re-pair: gold whatsapp")
