...
Helper script path: ~/.gold/skills/blockchain/base/scripts/base_client.py
...
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py stats
```
...
```bash
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py \
...
```bash
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py gas
```
...
```bash
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py price ETH
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py price USDC
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py price AERO
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py price DEGEN
python3 ~/.gold/skills/blockchain/base/scripts/base_client.py price 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913
```
