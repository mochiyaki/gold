...
Data file: $GOLD_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_GOLD_HOME = Path(os.environ.get("GOLD_HOME", Path.home() / ".gold"))
DATA_DIR = _GOLD_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
