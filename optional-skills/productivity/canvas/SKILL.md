...
4. Name the token (e.g., "Gold Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.gold/.env`:
...
```bash
CANVAS="python $GOLD_HOME/skills/productivity/canvas/scripts/canvas_api.py"
