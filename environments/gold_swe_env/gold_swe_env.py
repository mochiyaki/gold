"""
GoldSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser gold
    run-api
    python environments/gold_swe_env.py serve \\
...
class GoldSweEnv(GoldAgentBaseEnv):
    ...
    name = "gold-swe"
    env_config_cls = GoldSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[GoldSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = GoldSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="mochiyaki/DeepGold-3-Llama-3-3B-Preview",
            tool_call_parser="gold",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="gold-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="mochiyaki/DeepGold-3-Llama-3-3B-Preview",
