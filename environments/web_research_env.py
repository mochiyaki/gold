...
Inspired by: GroceryMind — production Gold agent doing live web research
             across German grocery stores (firecrawl + gold)
"""
...
class WebResearchEnvConfig(GoldAgentEnvConfig):
...
class WebResearchEnv(GoldAgentBaseEnv):
    """
