...
Provides a layered integration between gold's tool-calling capabilities
...
Core layers:
    ...
    - gold_base_env: Abstract base environment (BaseEnv subclass) for Atropos
    - tool_call_parsers: Client-side tool call parser registry for Phase 2 (VLLM /generate)

Concrete environments:
    - terminal_test_env/: Simple file-creation tasks for testing the stack
    - gold_swe_env/: SWE-bench style tasks with Modal sandboxes
