...
- **Dataset (ours):** [mochiyaki/openthoughts-tblite](https://huggingface.co/datasets/mochiyaki/openthoughts-tblite)
- **Docker images:** `mochiyaki/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `mochiyaki/terminal-bench-2`  | `mochiyaki/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
