...
ALL gold tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all gold tools for a specific rollout.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("GOLD_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("GOLD_QUIET", None)
            else:
                os.environ["GOLD_QUIET"] = _prev_quiet
