"""
GoldAgentLoop -- Reusable Multi-Turn Agent Engine

Runs the gold tool-calling loop using standard OpenAI-spec tool calling.
...
identical to gold's run_agent.py. Tool execution is dispatched via
...
# Resized at runtime by GoldAgentBaseEnv.__init__ via resize_tool_pool().
...
def resize_tool_pool(max_workers: int):
    ...
    Called by GoldAgentBaseEnv.__init__ based on config.tool_pool_size.
...
class GoldAgentLoop:
    """
    Runs gold's tool-calling loop using standard OpenAI-spec tool calling.
    ...
    async def run(self, messages: List[Dict[str, Any]]) -> AgentResult:
        ...
        for turn in range(self.max_turns):
            ...
            # gold's standalone parsers. This handles the case where
            ...
            if (
                ...
                try:
                    ...
                    fallback_parser = get_parser("gold")
            ...
            if assistant_msg.tool_calls:
                ...
                # Execute each tool call via gold's dispatch
