"""
Monkey patches for making gold tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by gold_base_env.py).
