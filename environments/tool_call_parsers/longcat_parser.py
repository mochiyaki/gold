...
Same as Gold but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser (extends Gold2ProToolParser).
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to Gold, just different tag names.
    """
