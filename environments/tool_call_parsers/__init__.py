...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("gold")
        class GoldToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "gold", "mistral", "llama3_json")
...
from environments.tool_call_parsers.gold_parser import GoldToolCallParser  # noqa: E402, F401
