...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Gold Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Gold Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Gold Agent",
    },
    {
...
class TerminalTestEnv(GoldAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/gold/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="mochiyaki/q-30b-t-h45-e1",
