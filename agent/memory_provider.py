...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - gold_home (str): The active GOLD_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.gold``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "gold").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'gold memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], gold_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'gold memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``gold_home`` is the active GOLD_HOME directory path.
