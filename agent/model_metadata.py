...
# Minimum context length required to run Gold Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Gold from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    "inference-api.mochiyaki.com": "nous",
...
def _get_context_cache_path() -> Path:
    ...
    return get_gold_home() / "context_length_cache.yaml"
        ...
        with httpx.Client(timeout=3.0) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Gold grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Gold sends to providers:
