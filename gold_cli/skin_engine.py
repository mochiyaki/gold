"""Gold CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.gold/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Gold Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ◆"              # Shown on exit
      response_label: " ◆ Gold "       # Response box header label
...
.. code-block:: python
    ...
    from gold_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Gold Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.gold/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Gold gold/kawaii (the current look)
...
Drop a YAML file in ``~/.gold/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces GOLD_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces GOLD_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Gold — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Gold Agent",
            "welcome": "Welcome to Gold Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ◆",
            "response_label": " ◆ Gold ",
            "prompt_symbol": "❯ ",
