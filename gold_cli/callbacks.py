...
into prompt_toolkit's event loop. Each function takes the GoldCLI instance
...
from gold_cli.banner import cprint, _DIM, _RST
from gold_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.gold/.env and never exposed to the model.
    """
