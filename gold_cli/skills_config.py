"""
Skills configuration for Gold Agent.
`gold skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.gold/config.yaml under:
...
from gold_cli.platforms import PLATFORMS as _PLATFORMS
